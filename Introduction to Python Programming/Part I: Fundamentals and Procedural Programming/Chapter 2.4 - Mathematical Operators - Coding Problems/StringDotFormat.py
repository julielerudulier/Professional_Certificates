...
#Add your code here!
summation = mystery_value_1 + mystery_value_2
diff = mystery_value_1 - mystery_value_2
product = mystery_value_1 * mystery_value_2
quotient = mystery_value_1 / mystery_value_2

print("The sum is {0}, the difference is {1}, the product is {2}, and the quotient is {3}.".format(summation, diff, product, quotient))
