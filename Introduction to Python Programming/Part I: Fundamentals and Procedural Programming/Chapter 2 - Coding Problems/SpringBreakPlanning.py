...
#Add your code here!
first = (can_afford and destination_is_safe) or (not can_afford and destination_is_safe and (educational_value or relatives_nearby))

second = (is_international and have_passport and not afraid_to_fly) or (not is_international and (have_a_car or not afraid_to_fly))

third = (is_a_beach and is_warm) or (has_skiing and not is_warm) or (is_a_city and (is_off_peak or has_attraction)) or (is_a_beach and is_a_city and ((is_a_beach and is_warm) or (is_a_city and (is_off_peak or has_attraction)))) or (has_skiing and is_a_city and ((has_skiing and not is_warm) or (is_a_city and (is_off_peak or has_attraction))))
