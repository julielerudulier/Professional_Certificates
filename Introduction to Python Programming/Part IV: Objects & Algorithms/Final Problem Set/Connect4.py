...
def check_winner(lst):
    ...
    for c in range(col - 3):
        for r in range(row):
            if lst[r][c] == x and lst[r][c+1] == x and \
            lst[r][c+2] == x and lst[r][c+3] == x:
                return "X"
            
            if lst[r][c] == o and lst[r][c+1] == o and \
            lst[r][c+2] == o and lst[r][c+3] == o:
                return "O"

    for c in range(col):
        for r in range(row - 3):
            if lst[r][c] == x and lst[r+1][c] == x and \
            lst[r+2][c] == x and lst[r+3][c] == x:
                return "X"
            
            if lst[r][c] == o and lst[r+1][c] == o and \
            lst[r+2][c] == o and lst[r+3][c] == o:
                return "O"
            
    for c in range(col - 3):
        for r in range(row - 3):
            if lst[r][c] == x and lst[r+1][c+1] == x and \
            lst[r+2][c+2] == x and lst[r+3][c+3] == x:
                return "X"
            
            if lst[r][c] == o and lst[r+1][c+1] == o and \
            lst[r+2][c+2] == o and lst[r+3][c+3] == o:
                return "O"
